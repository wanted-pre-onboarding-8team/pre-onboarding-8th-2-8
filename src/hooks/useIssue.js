import { addIssue, deleteIssue, patchIssue } from 'apis/issue';
...
const useIssue = () => {
  ...
  return { handleShowDetailIssue, handleAddIssue, handlePatchIssue, handleDeleteIssue };
};
